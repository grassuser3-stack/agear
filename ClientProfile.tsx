...
const aiAgendaSuggestions = [
  "Review ISP upgrade options for family of 3 (Chase, Linda, Anne)",
  "Present education endowment illustration — 18-year plan for Anne",
  "Discuss will drafting referral — follow up from March",
  "Update on second property investment plans",
  "Review current portfolio allocation given new income level",
];
