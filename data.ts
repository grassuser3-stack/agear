    ...
    meetingHistory: [
      {
        ...
        duration: "60 min",
        summary:
          "Reviewed existing portfolio. Chase expressed interest in increasing equity exposure. Discussed Integrated Shield Plan upgrade for the family. Anne was 2 months old at the time — Chase was sleep-deprived but in good spirits.",
        topics: ["Portfolio review", "ISP upgrade", "Education endowment intro"],
        actionItems: [
